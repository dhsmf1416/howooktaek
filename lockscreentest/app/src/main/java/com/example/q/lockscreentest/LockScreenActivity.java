...
public class LockScreenActivity extends AppCompatActivity {
    ...
    public TaskListItem getItem(int position){ return mTaskList.get(position); }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ListviewAdapter(this, R.layout.task_lv, mTaskList);
        ...
        System.out.println("!");
        PostHttp_labeling postHttp = new PostHttp_labeling(this);
        postHttp.execute("https://mymy.koreacentral.cloudapp.azure.com/api/image");
        ...
        lv_main.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                switch (id_int) {
                    case 1000:
                        Post_LabelingTaskHttp postLabelingTaskHttp = new Post_LabelingTaskHttp(LockScreenActivity.this);
...
//        });
        ...
        test_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LockScreenActivity.this, TaskExaminingActivity.class);
